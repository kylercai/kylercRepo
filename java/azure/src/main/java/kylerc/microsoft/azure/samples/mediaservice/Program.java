...
public class Program
{
    ...
    public static void main(String[] args)
    {
        ...
        try {
            ...
            //AssetInfo uploadAsset = uploadFileAndCreateAsset("Video Name", "d:\\VMwareVideo5Failback_high.mp4");
            AssetInfo uploadAsset = uploadFileAndCreateAsset("tryVideo001", "d:\\VMwareVideo5Failback_high.mp4");
